			...
			<div class="main-content-w3">
				<div class="sap_tabs-w3agile">	
					<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						...
						<p class="tab-text">Rider Registration</p>
							<div class="register ">
								<form method="post" action="rconnect.php">											
									<input placeholder="address" name="address" class="driver" type="text" required="">
									<input placeholder="Nearest Pick-up Point" name="pick" class="driver" type="text" required="">
